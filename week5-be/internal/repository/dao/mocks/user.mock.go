...
//
//	mockgen -package cachemocks -source .\internal\repository\dao\user.go -destination .\internal\repository\dao\mocks\user.mock.go
//
...
import (
	context "context"
	dao "geek-hw-week5/internal/repository/dao"
	reflect "reflect"
