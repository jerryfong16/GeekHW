...
//
//	mockgen -package cachemocks -source .\internal\repository\cache\user.go -destination .\internal\repository\cache\mocks\user.mock.go
//
...
func (m *MockUserCache) Set(ctx context.Context, domainUser domain.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Set", ctx, domainUser)
	ret0, _ := ret[0].(error)
	return ret0
}

// Set indicates an expected call of Set.
func (mr *MockUserCacheMockRecorder) Set(ctx, domainUser any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Set", reflect.TypeOf((*MockUserCache)(nil).Set), ctx, domainUser)
}
