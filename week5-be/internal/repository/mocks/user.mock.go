...
//
//	mockgen -package repomocks -source .\internal\repository\user.go -destination .\internal\repository\mocks\user.mock.go
//
...
// UpdateNonsensitiveFields mocks base method.
func (m *MockUserRepository) UpdateNonsensitiveFields(ctx context.Context, user domain.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateNonsensitiveFields", ctx, user)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateNonsensitiveFields indicates an expected call of UpdateNonsensitiveFields.
func (mr *MockUserRepositoryMockRecorder) UpdateNonsensitiveFields(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateNonsensitiveFields", reflect.TypeOf((*MockUserRepository)(nil).UpdateNonsensitiveFields), ctx, user)
}
